...
var _user$project$Main$view = function (issues) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('stories'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
...
var _user$project$Main$decodeLabel = A2(
...
var _user$project$Main$decodeIssues = A2(
	...
	_elm_lang$core$Json_Decode$list(_user$project$Main$decodeIssue));
var _user$project$Main$ListIssues = function (a) {
	return {ctor: 'ListIssues', _0: a};
};
var _user$project$Main$listIssues = function (token) {
	var search = A2(
	...
	var request = _elm_lang$http$Http$request(
		{
			...
			body: A2(
				...
				A2(
					...
					'{\"query\":',
					A2(_elm_lang$core$Basics_ops['++'], search, '}'))),
			expect: _elm_lang$http$Http$expectJson(_user$project$Main$decodeIssues),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		});
	return A2(_elm_lang$http$Http$send, _user$project$Main$ListIssues, request);
};
var _user$project$Main$init = function (token) {
	return {
		ctor: '_Tuple2',
		_0: {ctor: '[]'},
		_1: _user$project$Main$listIssues(token)
	};
};
